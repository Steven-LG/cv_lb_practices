...
def is_px_within_range(c_px_i, c_px_coords, n_obj, n_n):
    if (reference_pixel_intensity - intensity_difference) <= c_px_i <= (reference_pixel_intensity + intensity_difference):
...
def recursive_run(c_px_i, c_px_coords, n_obj, n_n):
    if not(is_px_within_range(c_px_i, c_px_coords, n_obj, n_n)):
        return
...
reference_pixel_intensity = intensity_matrix[0][0]
